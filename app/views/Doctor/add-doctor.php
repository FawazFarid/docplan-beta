...
<div class = "ui text container">
    <form class="ui form segment" action="<?php echo URL; ?>register/createdoctor" method="post">
        <h4 class= "ui dividing header">Register Doctor</h4>
        ...
        <div class="ui search selection dropdown field">
            <input name="specialty" type="hidden">
        ...
        <div class="field">
            ...
            <input id="qualification" name="qualification" placeholder="qualification" type="text">
        </div>
        ...
        <div class="field">
            <input type="submit" value= "Register" class ="ui blue button" name = "submit_add_doctor">
        </div>
